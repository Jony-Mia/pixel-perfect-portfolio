...
const About = () => {
  ...
  const stats = [
    ...
    { icon: 'https://cdn-icons-png.flaticon.com/128/3113/3113025.png', value: '35+', label: t('hero.projects') },
    { icon: 'https://cdn-icons-png.flaticon.com/128/1256/1256650.png', value: '20+', label: t('hero.clients') },
